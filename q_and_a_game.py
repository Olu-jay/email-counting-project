questions = [
    ...
    "options": ["A. Madrid", "B. Rome", "C. Paris", "D. Berlin", "E. Lisbon"],
    "answer": "C"
     },
    ...
    "options": ["A. Brain", "B. Heart", "C. Skin", "D. Liver", "E. Stomach"],
    "answer": "C"
     },
     {"prompt": "4. Who wrote Hamlet?",
    "options": ["A. Charles Dickens", "B. William Shakespeare", "C. J.K. Rowling", "D. Mark Twain", "E. George Orwell"],
    "answer": "B"
     },
    ...
    "options": ["A. Oxygen", "B. Carbon Dioxide", "C. Nitrogen", "D. Hydrogen", "E. Methane"],
    "answer": "B"
     },
     {"prompt": "8. Who painted the Mona Lisa?",
    "options": ["A. Pablo Picasso", "B. Vincent van Gogh", "C. Leonard da vinci", "D. Caude Monet", "E. Michelangelo"],
    "answer": "C"
     },
    ...
    "options": ["A. Atlantic Ocean", "B. Indian Ocean", "C. Artic Ocean", "D. Pacific Ocean", "E. Southern Ocean"],
    "answer": "D"
     }
]
